	...
	<div class="wrap">
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				<div class="container" >
				<a class="brand" href="file:///C:/Users/HP/OneDrive/Desktop/Online%20Marketing/index.html" ><i class="fa fa-home" aria-hidden="true"></i>&nbsp;HOME</a>
		...
		<div class="span12 well pass1">
			<div>
						...
						<div style="float: right;">
							<b><p>   Qlonz store Men Solid Casual Blue Shirt<br>  Fabric: Cotton Polyester Nylon Blend Regular Fit, Full Sleeve<br>   Collar Type: Button Down Pattern: Solid Set of 1 <br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="cloth1.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br>
					<div>
						...
						<div style="float: right;">
							<b><p>    Peter England University Regular Men Blue Jeans<br>  <br> Fit: Regular Fabric: Cotton Lycra Blend <br>  Light Fade Mid Rise Jeans Clean Look <br><br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1500</del>&nbsp;&nbsp;4% off</p></b>
								<a href="cloth2.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="payment.php" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
							<!-- <p>HP Pavilion Core i7 8th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB Graphics) 15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)</p>
							 -->
