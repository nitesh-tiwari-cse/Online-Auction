	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div style="float:right; font-size:20px;margin-top:20px;">
				...
				<a href="#" class="btn btn-info">Signup</a><br/><br/>&nbsp;&nbsp;
		...
		<div class="navbar navbar-inverse">
			<div class="navbar-inner">
				...
				<a class="brand" href="#" >FIND TRAIN</a>
		...
		<div class="span12 well pass1">
			<div>
						...
						<div style="float: right;">
							<b><p>  Zebronics G31 Motherboard  (Black)<br> Suitable For Desktop
                                Intel G31 <br>  Maximum RAM Capacity 4 GBForm Factor: Micro-ATX <br>15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)<br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="hardware1.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br>
					<div>
						...
						<div style="float: right;">
							<b><p>   MSI NVIDIA GTX 1050 Ti 4 GB GDDR5 Graphics Card<br>  <br> 1455 MHzClock Speed Chipset: NVIDIA <br>  BUS Standard: PCI E X16 Graphics Engine: Geforce GTX 1050 Ti <br><br> Memory Interface 128 bit<br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1500</del>&nbsp;&nbsp;4% off</p></b>
								<a href="hardware2.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="payment.php" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
							<!-- <p>HP Pavilion Core i7 8th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB Graphics) 15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)</p>
							 -->
