		...
		<div class="span12 well pass1">
			<div>
						...
						<div style="float: right;">
							<b><p  > HP Pavilion Core i7<br> 8th Gen - (8 GB/1 TB HDD/128 GB <br>SSD/Windows 10 Home/4 GB Graphics) <br>15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)<br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="laptop1.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="#" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
				...
				<br>
					<div>
						...
						<div style="float: right;">
							<b><p>  Apple MacBook Pro Core i5<br>  <br> 7th Gen - (8 GB/128 GB SSD/Mac OS Sierra) <br>  MPXQ2HN/A  (13.3 inch, Space Grey, 1.37 kg)<br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1500</del>&nbsp;&nbsp;4% off</p></b>
								<a href="laptop2.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="#" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
							<!-- <p>HP Pavilion Core i7 8th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB Graphics) 15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)</p>
							 -->
