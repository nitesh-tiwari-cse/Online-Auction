		...
		<div class="span12 well pass1">
			<div>
						...
						<div style="float: right;">
							<b><p>   Redmi Note 4 (Dark Grey, 64 GB)  (4 GB RAM)<br>4 GB RAM | 64 GB ROM |<br> Expandable Upto 128 GB 13.97 cm (5.5 inch) Full HD Display<br>    3MP Rear Camera | 5MP Front Camera 4100 mAh <br>Li-Polymer Battery Qualcomm Snapdragon 625<br> 64-bit Octa Core 2GHz Processor <br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="smartphones1.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br>
					<div>
						...
						<div style="float: right;">
							<b><p>   Apple iPhone X (Silver, 64 GB)<br>  <br>  64 GB ROM | 14.73 cm (5.8 inch)<br> Super Retina HD Display <br>  12MP + 12MP | 7MP Front Camera<br> A11 Bionic Chip with 64-bit Architecture, Neural Engine, <br>Embedded M11 Motion Coprocessor Processor <br><br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1500</del>&nbsp;&nbsp;4% off</p></b>
								<a href="smartphones2.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="payment.php" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
							<!-- <p>HP Pavilion Core i7 8th Gen - (8 GB/1 TB HDD/128 GB SSD/Windows 10 Home/4 GB Graphics) 15-cx0144TX Gaming Laptop  (15.6 inch, Shadow Black, 2.17 kg)</p>
							 -->
