		...
		<div class="span12 well pass1">
			<div>
						...
						<div style="float: right;">
							<b><p>   deziine Repairing Tool Set 16 pcs-Tool Kit Set, Hand Tool Set<br> Portable Tool Set, Car Tool - (Set of 16) Vehicle Tool Kit  <br>   1pc Combination pliers,1pc 8" adjustable wrench,1pc Utility knife <br> 1pc test pen,1pc tape measure(2m),1pc screwdrivers 3*75,1pc blow case <br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="tool1.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<br>
					<div>
						...
						<div style="float: right;">
							<b><p>   deziine Repairing Tool Set 16 pcs-Tool Kit Set, Hand Tool Set<br> Portable Tool Set, Car Tool - (Set of 16) Vehicle Tool Kit  <br>   1pc Combination pliers,1pc 8" adjustable wrench,1pc Utility knife <br> 1pc test pen,1pc tape measure(2m),1pc screwdrivers 3*75,1pc blow case <br> <br>
								<del><i class="fa fa-inr" aria-hidden="true"></i>1200</del>&nbsp;&nbsp;8% off</p></b>
								<a href="tool2.php" class="btn btn-info">Add to Cart</a>&nbsp;&nbsp;&nbsp;&nbsp;
				                <a href="payment.php" class="btn btn-info">Buy Now</a><br/><br/>&nbsp;&nbsp;
